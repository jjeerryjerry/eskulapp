...
INSERT INTO partners (event_id,name,description,tier,booth_location,website,sort) VALUES
 (@e,'NefroMed Polska','Dializa i terapie nerkozastępcze','strategiczny','Stoisko A1','nefromed.pl',0),
 ...
 (@e,'UroSystems','Urządzenia urologiczne','partner','Stoisko A5','urosystems.pl',4),
 (@e,'BioFiltr','Filtry i dreny medyczne','wspierający','Stoisko A6','biofiltr.pl',5),
 ...
 (@e,'KidneyTech','Monitoring nerek','wspierający','Stoisko A9','kidneytech.pl',8),
 (@e,'EduMed','Materiały edukacyjne dla rodziców','wspierający','Stoisko A10','edumed.pl',9);

-- ============ TEST02 (diabetologia), stoiska D1..D10 ============
SET @e = (SELECT id FROM events WHERE access_code='TEST02');
DELETE FROM partners WHERE event_id=@e;
INSERT INTO partners (event_id,name,description,tier,booth_location,website,sort) VALUES
 (@e,'DiabCare Systems','Systemy ciągłego monitorowania glikemii','strategiczny','Stoisko D1','diabcare.pl',0),
 (@e,'InsulinaPlus','Pompy insulinowe i akcesoria','partner','Stoisko D2','insulinaplus.pl',1),
 (@e,'MediEdu','Platforma edukacyjna dla pacjentów','wspierający','Stoisko D3','mediedu.pl',2),
 ...
 (@e,'NutriCare','Żywienie w cukrzycy','wspierający','Stoisko D7','nutricare.pl',6),
 (@e,'FootCare Clinic','Profilaktyka stopy cukrzycowej','wspierający','Stoisko D8','footcare.pl',7),
