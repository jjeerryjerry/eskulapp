    ...
    private static function fromDb(PDO $pdo, string $code): ?array
    {
        ...
        return [
            'event' => [
                ...
                // Oceny prelekcji (SPEC-OCENY): apka liczy okno lokalnie (UI),
                // serwer (POST .../rating) jest jedynym zrodlem prawdy.
                'ratings_enabled' => (bool)($ev['ratings_enabled'] ?? 1),
                'ratings_open_after_start_min' => (int)($ev['ratings_open_after_start_min'] ?? Ratings::DEFAULT_OPEN_MIN),
                'ratings_close_after_end_min' => (int)($ev['ratings_close_after_end_min'] ?? Ratings::DEFAULT_CLOSE_MIN),
    ...
    private static function demo(string $code): ?array
    {
        ...
        return [
            'event' => [
                ...
                'ratings_enabled' => true, 'ratings_open_after_start_min' => Ratings::DEFAULT_OPEN_MIN,
                'ratings_close_after_end_min' => Ratings::DEFAULT_CLOSE_MIN,
